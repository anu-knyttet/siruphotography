...
const mockTeam = [
  {
    ...
    socials: {
      ...
      tiktok: "https://www.tiktok.com/@sirubhurtel",
      youtube: "https://www.youtube.com/@sirubhurtelphotography",
    },
  },
  {
    id: "2",
  ...
  return (
    <main className="bg-background min-h-screen text-foreground">
      ...
      <section className="py-12">
        ...
        <div className="gap-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 mx-auto px-4 max-w-[60rem]">
          {mockTeam.map((member) => (
