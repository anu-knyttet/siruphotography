          ...
          <div className="items-center gap-16 lg:gap-24 grid lg:grid-cols-2">
            ...
            <div className="lg:order-1">
              <div className="max-w-xl">
                ...
                <h2 className="mb-8 font-serif font-light text-foreground text-4xl md:text-5xl text-balance leading-tight">
                  Hi, I&apos;m <em className="font-serif text-primary italic">Siru!</em>
                </h2>
      ...
      <section className="bg-secondary/30 px-6 py-24">
        <div className="mx-auto max-w-4xl">
          <div className="mb-16 text-center">
            ...
            <h2 className="font-serif font-light text-primary text-4xl md:text-5xl text-balance leading-tight">
          ...
          <div className="space-y-12">
            <div className="max-w-none prose prose-lg">
              <p className="first-letter:float-left first-letter:mt-1 first-letter:mr-3 first-letter:font-serif text-foreground first-letter:text-primary text-lg first-letter:text-6xl leading-relaxed">
            ...
            <div className="gap-12 grid md:grid-cols-2">
              <div>
                <h3 className="mb-4 font-serif font-light text-primary text-2xl">Recognition & Awards</h3>
              ...
              <div>
                <h3 className="mb-4 font-serif font-light text-primary text-2xl">International Training</h3>
                <p className="text-muted-foreground leading-relaxed">
            ...
            <div className="pt-8 text-center">
              <blockquote className="font-serif font-light text-primary text-2xl md:text-3xl italic text-balance leading-relaxed">
